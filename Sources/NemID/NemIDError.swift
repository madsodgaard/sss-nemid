...
// MARK: - Codable
extension NemIDError: Codable {}

// MARK: - CustomStringConvertible
extension NemIDError: CustomStringConvertible {
    public var description: String {
        "NemIDError.\(self.rawValue): \(self.englishDescrption)"
    }
}

// MARK: - LocalizedError
extension NemIDError: LocalizedError {
